...
def generate(table, dir) {
    ...
    new File(dir, className + "Dao.java").withPrintWriter { out -> generate(out, className, table.getName(), fields) }
}
...
def generateMapResultSet(out, className, fields) {
    ...
    fields.each() {
        ...
        if(it.isNullable) out.println "\t\tif(rs.wasNull()) obj.set${it.name.capitalize()}(null); //${it.spec}"
    }
